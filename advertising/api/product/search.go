...
import (
	...
	"github.com/bububa/rakuten-go/advertising/model/product"
)
...
// Keyword(s)
func Search(ctx context.Context, clt *advertising.Client, req *product.SearchRequest, accessToken string) (*product.SearchResult, error) {
